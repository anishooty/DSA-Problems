...
class KClosestPointsToOrigin {
    ...
    public static long[][] kClosestPointsToOrigin(long[][] points, int k) {
        ...
        PriorityQueue<long[]> minHeap = new PriorityQueue<>((a, b) -> Long.compare(distanceFromOrigin(a), distanceFromOrigin(b)));
    ...
    private static long distanceFromOrigin(long[] point) {
