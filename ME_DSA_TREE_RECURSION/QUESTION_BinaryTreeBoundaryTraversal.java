...
private void leftBoundary(TreeNode node, ArrayList<Long> result) {
...
private void rightBoundary(TreeNode node, ArrayList<Long> result) {
...
private void leaves(TreeNode node, ArrayList<Long> result) {
    if (node == null) {
        return;
    }
